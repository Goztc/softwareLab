...
public class AliOssUtil {
    ...
    private static final String ACCESS_KEY_ID="LTAI5t6Tc68u2k5ccTpFxuKq";
    private static final String ACCESS_KEY_SECRET="aTZssRCewHQmsW8S27UqSyEpKTCPZJ";
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKET_NAME = "aircraft-1111";
